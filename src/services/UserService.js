...
class UserService {
  ...
  /**
   * Оновити поле channel_paused для користувача
   * @param {string} telegramId
   * @param {boolean} paused - true щоб зупинити публікації, false щоб відновити
   * @returns {Promise<boolean>}
   */
  updateUserChannelPaused(telegramId, paused) {
    return usersDb.updateUserChannelPaused(telegramId, paused);
  }

  /**
   * Оновити налаштування формату каналу
   * @param {string} telegramId
   * @param {object} settings
   * @returns {Promise<boolean>}
   */
  updateUserFormatSettings(telegramId, settings) {
    return usersDb.updateUserFormatSettings(telegramId, settings);
  }

  /**
   * Отримати користувача за внутрішнім числовим ID (первинний ключ БД)
   * @param {number} id - Внутрішній числовий ID користувача
  ...
  /**
   * Скинути брендинг і встановити новий канал для користувача (channel_id, channel_title тощо → defaults)
   * @param {string} telegramId
   * @param {string} channelId
   * @returns {Promise<boolean>}
   */
  resetUserChannel(telegramId, channelId) {
    return usersDb.resetUserChannel(telegramId, channelId);
  }
   ...
   * @returns {Promise<boolean>}
   */
  updateUserChannel(telegramId, channelId) {
    return usersDb.updateUserChannel(telegramId, channelId);
  }

  /**
   * Оновити брендинг каналу
   * @param {string} telegramId
   * @param {object} brandingData
   * @returns {Promise<boolean>}
   */
  updateChannelBranding(telegramId, brandingData) {
    return usersDb.updateChannelBranding(telegramId, brandingData);
  }

  /**
   * Частково оновити брендинг каналу
   * @param {string} telegramId
   * @param {object} brandingData
   * @returns {Promise<boolean>}
   */
  updateChannelBrandingPartial(telegramId, brandingData) {
    return usersDb.updateChannelBrandingPartial(telegramId, brandingData);
  }
