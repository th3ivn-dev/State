module.exports = {
  ...
  // Channel Guard
  CHANNEL_GUARD_CRON: '0 3 * * *',
  CHANNEL_GUARD_BATCH_SIZE: 5,
  CHANNEL_GUARD_DELAY_BETWEEN_BATCHES_MS: 1000,
  CHANNEL_GUARD_DELAY_BETWEEN_REQUESTS_MS: 200,
  CHANNEL_GUARD_RETRY_ATTEMPTS: 3,
  CHANNEL_GUARD_RETRY_BASE_DELAY_MS: 1000,
  CHANNEL_GUARD_BRANDING_GRACE_HOURS: 24,
